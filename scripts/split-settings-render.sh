...
echo ""
echo "Split settings-render.js into smaller render modules"
echo ""

FILES=(
  "js/settings/settings-render.js"
  "js/settings/settings-layout-render.js"
  "js/settings/settings-customers-render.js"
  "js/settings/settings-products-render.js"
  "js/settings/settings-packaging-render.js"
)
...
if [[ "$WRITE_MODE" == false ]]; then
  ...
  echo ""
  echo "  bash scripts/split-settings-render.sh --write"
  echo ""
  exit 0
fi
...
cat > js/settings/settings-render.js <<'JS'
import {
  renderSettingsLayout as renderSettingsLayoutHtml
} from './settings-layout-render.js'
...
cat > js/settings/settings-layout-render.js <<'JS'
...
cat > js/settings/settings-customers-render.js <<'JS'
...
cat > js/settings/settings-products-render.js <<'JS'
import { state } from '../state.js'
import { escapeHtml } from '../utils/html.js'
...
cat > js/settings/settings-packaging-render.js <<'JS'
