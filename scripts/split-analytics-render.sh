...
echo ""
echo "Split analytics-render.js into smaller render modules"
echo ""

FILES=(
  "js/analytics/analytics-render.js"
  "js/analytics/analytics-formatters.js"
  "js/analytics/analytics-kpi-render.js"
  "js/analytics/analytics-progress-render.js"
  "js/analytics/analytics-sections-render.js"
)
...
if [[ "$WRITE_MODE" == false ]]; then
  ...
  echo ""
  echo "  bash scripts/split-analytics-render.sh --write"
  echo ""
  exit 0
fi
...
cat > js/analytics/analytics-render.js <<'JS'
...
cat > js/analytics/analytics-formatters.js <<'JS'
...
cat > js/analytics/analytics-kpi-render.js <<'JS'
import { escapeHtml } from '../utils/html.js'
...
cat > js/analytics/analytics-progress-render.js <<'JS'
import { escapeHtml } from '../utils/html.js'
...
cat > js/analytics/analytics-sections-render.js <<'JS'
import { escapeHtml } from '../utils/html.js'
import { formatKg } from './analytics-formatters.js'
